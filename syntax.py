...
def make_parser():
  ...
  def make_fancy_grammar(prec_order, ps):
    ...
    #
    # With this precedence-climbing setup, the exponential blowup seems confined
    # to terms of the form
    #   ((((((((e))))))))
    # and is exponential in the number of ()s. This occurs when there are
    # multiple incomparable ways to get to top_top. In such a situation the
    # generated grammar looks something like
    #   bot_bot : a | b
    #   a : ... | something that leads to top_top
    #   b : ... | something that leads to top_top
    #   top_top : "(" bot_bot ")" | ...
    # and now there is a reduce-reduce conflict at EOF because it's unclear
    # whether a top_top should be reduced to an instance of a or b. To see this
    # more clearly print the grammars generated by Example 1 below.
    #
